 ...
 *
 *
 * @param string $callback|Event Method to fire on all the objects. Its assumed all the objects implement
 ...
 */
	public function trigger($callback, $params = array(), $options = array()) {
		...
		if ($callback instanceof Event) {
			...
			//TODO: Temporary BC check, while we move all the triggers system into the EventManager
