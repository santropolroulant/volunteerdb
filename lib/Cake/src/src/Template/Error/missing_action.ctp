 ...
 */
?>
<h2><?php echo __d('cake_dev', 'Missing Method in {0}', $controller); ?></h2> <p class="error">
...
<p class="notice">
	...
	<?php echo __d('cake_dev', 'If you want to customize this error message, create {0}', APP_DIR . DS . 'View' . DS . 'Errors' . DS . 'missing_action.ctp'); ?>
</p>
