 ...
 * @return void
 * @throws \Exception when you use non-string values.
 */
	public function append($name, $value = null) {
		if (isset($value)) {
			if (!is_string($value)) {
				throw new \Exception(__d('cake_dev', '$value must be a string.'));
			}
 ...
 */
	public function set($name, $value) {
		if (!is_string($value)) {
			throw new \Exception(__d('cake_dev', 'Blocks can only contain strings.'));
		}
		$this->_blocks[$name] = $value;
	}
