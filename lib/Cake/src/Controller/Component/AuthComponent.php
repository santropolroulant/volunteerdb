 ...
 * @param Request $request The request to authenticate for.  If empty, the current request will be used.
	...
	public function constructAuthorize() {
		...
		foreach ($config as $class => $settings) {
			...
			if (!method_exists($className, 'authorize')) {
				throw new \Exception(__d('cake_dev', 'Authorization objects must implement an authorize method.'));
			}
	...
	public function constructAuthenticate() {
		...
		foreach ($config as $class => $settings) {
			...
			if (!method_exists($className, 'authenticate')) {
				throw new \Exception(__d('cake_dev', 'Authentication objects must implement an authenticate method.'));
			}
			$settings = array_merge($global, (array)$settings);
