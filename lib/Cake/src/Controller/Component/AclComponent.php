 ...
 */
	public function grant($aro, $aco, $action = "*") {
		trigger_error(__d('cake_dev', 'AclComponent::grant() is deprecated,		return $this->_Instance->allow($aro, $aco, $action);
	}
 ...
 */
	public function revoke($aro, $aco, $action = "*") {
		trigger_error(__d('cake_dev', 'AclComponent::revoke() is deprecated,		return $this->_Instance->deny($aro, $aco, $action);
	}
