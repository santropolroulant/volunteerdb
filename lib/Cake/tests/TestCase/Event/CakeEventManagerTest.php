 ...
 */
namespace lib\Cake\Test\Case\Event;
 ...
 * @package Cake.Test.Case.Event
 */
class CustomTestEventListerner extends CakeEventTestListener implements EventListener {
 ...
 */
	public function testDispatchWithGlobal() {
		$generalManager = $this->getMock('EventManager', array('dispatch'));
		$manager = new EventManager;
		$event = new Event('fake.event');
