 ...
 */
namespace lib\Cake\Console\Command;
 ...
 */
	public function main() {
		if (empty($this->params['xml'])) {
			...
			$this->out(__d('cake_console', "Your working path should be the same as your application path to change your path			$this->out(__d('cake_console', "Example: -app relative/path/to/myapp or -app /absolute/path/to/myapp"), 2);
